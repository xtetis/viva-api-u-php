    ...
    <div class="app-brand demo">
        <a href="index.html"
           class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">KBKI pdn</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->is('logs') ? 'active' : '' }}">
            <a href="{{ url('/logs') }}"
               class="menu-link">
                ...
                <div data-i18n="Boxicons">Логи</div>
            </a>
        </li>
		...
		<li class="menu-item {{ request()->is('settings') ? 'active' : '' }}">
			<a href="{{ url('/settings') }}"
				class="menu-link">
				<i class="menu-icon tf-icons bx bx-crown"></i>
				<div data-i18n="Boxicons">Настройки</div>
			</a>
		</li>
